...
import { TrendingUp, TrendingDown, Minus, MessageSquare, Star, AlertTriangle } from 'lucide-react';
...
export const AgencySentimentAnalytics: React.FC<AgencySentimentAnalyticsProps> = ({ reviews, tours }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      {tourSentimentData.length > 0 && (
        <div className="bg-white rounded-lg shadow p-6">
          <h4 className="text-lg font-medium text-gray-900 mb-4">Tour Performance by Sentiment</h4>
