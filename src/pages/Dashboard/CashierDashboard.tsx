...
export default function CashierDashboard() {
      ...
      if (paymentDoc.exists()) {
        ...
        if (paymentData.bookingId) {
          ...
          if (bookingDoc.exists()) {
            ...
            console.warn(
              'Booking document not found for bookingId during verification:',
        ...
        if (paymentDoc.exists()) {
          ...
          if (paymentData.bookingId) {
            ...
            if (bookingDoc.exists()) {
              ...
              console.warn(
                'Booking document not found for bookingId during bulk verification:',
                paymentData.bookingId
              );
            }
          }
  ...
  // Menu items for sidebar (Cashier only has one view)
  const menuItems = [
    { id: 'payments', label: 'Payment Management', icon: CreditCard, onClick: () => {}, active: true }
  ];
